## The Lp agnostic (invariant!) 1-NN algorithm illustration [Project «⅄⅃LY»]
...
# 6. Repeat the steps #2-#5 for other Lq, 0 < q ≤ 2 (q = 0.25 remains counterintuitive enough)

## &"C:\Program Files (x86)\Microsoft Visual Studio\Shared\Python37_64\pyton.exe" - YPMV (Your Path May Vary)
